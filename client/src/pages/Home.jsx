...
function Home() {
    ...
    return (
        <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
            ...
            {/* particle background - sabse pehle, behind everything */}
            <ParticleBackground />

            {/* yeh wrapper baaki sab content ko particles ke upar laayega */}
            <div className='relative z-10'>
                        ...
                        {highlights.map((h, i) => (
                            ...
                            >
                                ...
                                <p className='text-sm text-zinc-400'>
                                    WEBFORGE builds real websites — clean code,
                ...
                <footer className='border-t border-white/10 py-10 text-center text-sm text-zinc-500'>
                    &copy; {new Date().getFullYear()} WEBFORGE
                </footer>
